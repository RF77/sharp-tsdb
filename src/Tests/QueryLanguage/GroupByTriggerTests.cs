...
namespace Tests.QueryLanguage
{
    ...
    public class GroupByTriggerTests
    {
        ...
        public void Setup()
        {
            ...
            _serie = new QuerySerie<float>(_rows, new DateTime(1000, 1, 1,0,0,0, DateTimeKind.Utc), new DateTime(1000, 1, 1, 0, 22, 0, DateTimeKind.Utc))
            {
            ...
            _serie2 = new QuerySerie<float>(_rows.Take(6).ToList(), new DateTime(1000, 1, 1,0,0,0, DateTimeKind.Utc), new DateTime(1000, 1, 1, 0, 20, 0, DateTimeKind.Utc))
            {
                PreviousRow = new SingleDataRow<float>(new DateTime(99, 1, 1, 0, 11, 0, DateTimeKind.Utc), 8),
                NextRow = new SingleDataRow<float>(new DateTime(1000, 1, 1, 0, 26, 0, DateTimeKind.Utc), 11)
            };

            _serie3 = new QuerySerie<float>(_rows.Take(7).ToList(), new DateTime(1000, 1, 1,0,0,0, DateTimeKind.Utc), new DateTime(1000, 1, 1, 0, 20, 0, DateTimeKind.Utc))
            {
                PreviousRow = new SingleDataRow<float>(new DateTime(99, 1, 1, 0, 11, 0, DateTimeKind.Utc), 8),
                NextRow = new SingleDataRow<float>(new DateTime(1000, 1, 1, 0, 26, 0, DateTimeKind.Utc), 11)
            };
